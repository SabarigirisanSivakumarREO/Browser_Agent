...
function createMockPageState(options: {
  ...
  return {
    url: options.url || 'https://www.peregrineclothing.co.uk/collections/polo-shirts/products/lynton-polo-shirt?colour=Navy',
...
describe('Post-Processing Pipeline Integration Tests', () => {
  ...
  describe('Full Pipeline Integration', () => {
    ...
    it('should generate markdown report from pipeline output', () => {
      ...
      expect(report).toContain('https://www.peregrineclothing.co.uk/collections/polo-shirts/products/lynton-polo-shirt?colour=Navy');
