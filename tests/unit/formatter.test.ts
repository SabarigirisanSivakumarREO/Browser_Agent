...
describe('ResultFormatter', () => {
  ...
  describe('formatResult', () => {
    it('should format successful result', () => {
      ...
      expect(output).toContain('https://www.peregrineclothing.co.uk/collections/polo-shirts/products/lynton-polo-shirt?colour=Navy');
    ...
    it('should truncate long headings', () => {
      ...
      const result: AgentResult = {
        url: 'https://www.peregrineclothing.co.uk/collections/polo-shirts/products/lynton-polo-shirt?colour=Navy',
        pageLoad: { success: true, url: 'https://www.peregrineclothing.co.uk/collections/polo-shirts/products/lynton-polo-shirt?colour=Navy/' },
        extraction: {
